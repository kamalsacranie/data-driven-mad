...
#let article(
  ...
  set page(
    ...
    footer: move(dx: -52pt, dy: 4pt)[#rect(fill: aqua)[#text(size: 9pt)[Made with #link("https://typst.app/docs")[Typst] and love using #link("https://github.com/kamalsacranie/data-driven-mad")[my data driven CV library]]]],
  )
